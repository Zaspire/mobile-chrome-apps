...
var application = '<?xml version="1.0" encoding="UTF-8" ?><application id="' + manifest.name + '_' + manifest.version + '"><services><service id="' + manifest.name + '_cordova"><description>Post your pictures</description></service></services></application>';
fs.writeFileSync(path.join(platformDir, 'qml', 'app.application'), application);

var service = '<?xml version="1.0" encoding="UTF-8"?><service id="' + manifest.name + '_cordova"><type>share</type><name>Cordova</name><provider>google</provider></service>';
